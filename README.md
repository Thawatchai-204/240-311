...
product.js เป็นการเชื่อมไปยัง MongoDB  เพื่อใช้เก็บ Schema เก็บข้อมูลต่างๆคือ 
...
router '/insert'      เพื่อเป็นการบันทึกข้อมูลสินค้ารูปภาพหนังสือและราคาเข้าไปในฐานข้อมูล
...
* slideshow.ejs เป็นสไลด์เลื่อนด้านบนของเว็ปไซต์
